...
class wp_csv_to_db {
	...
	public function wp_csv_to_db_register(){
    	$wp_csv_to_db_page = add_submenu_page(
                    'edit.php?post_type=badge',
                    __('CSV File Upload','wp_csv_to_db'),
                    __('CSV File Upload','wp_csv_to_db'),
                    'manage_options',
                    'csv-custom-submenu-page', 
                    array( $this, 'wp_csv_to_db_menu_page' ) 
                    );
		...
		<div class="wrap">
        	...
        	<form id="wp_csv_to_db_form" method="post" action="">
                    <table class="form-table"> 
                        ...
                        <tr valign="top"><th scope="row"><?php _e('Select Content To Upload:','wp_csv_to_db'); ?></th>
                            <td>
                        ...
                        <tr valign="top"><th scope="row"><?php _e('Content Information:','wp_csv_to_db'); ?></th>
                            <td>
                                ...
                                $('#table_select').change(function() {
                                    ...
                                    switch(value){
                                        case "Languages" :
                                           ...
                                           break;
                                        case "Skills" :
                                           $('#db_table_description').text("What know the students : speaking, reading, writing, etc.");
                                           break;
                                        case "StudentLevels" :
                    ...
                    <p class="submit">
                        ...
                        <input id="export_to_csv_button" name="export_to_csv_button" type="submit" class="button-primary" value="<?php _e('Export to CSV', 'wp_csv_to_db') ?>" />
